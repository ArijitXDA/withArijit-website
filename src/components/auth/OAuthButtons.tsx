...
/**
 * OAuth login buttons for Google, GitHub, and Microsoft.
 * Can be placed on both SignIn and SignUp pages.
 */
    ...
    <div className="space-y-3">
      ...
      {PROVIDERS.map((provider) => (
        <button
          ...
          className={`w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl font-medium text-sm transition-all duration-200 ${provider.bgColor} ${provider.textColor} disabled:opacity-50`}
        >
