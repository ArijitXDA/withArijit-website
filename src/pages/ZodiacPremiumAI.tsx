...
const ZodiacPremiumAI: React.FC = () => {
  const { user } = useAuth()
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center bg-gradient-to-r from-yellow-500 to-orange-500 text-black px-6 py-3 rounded-full font-bold text-lg shadow-lg mb-8">
              <Star className="w-6 h-6 mr-2" />
              Zodiac Premium Exclusive
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              AI Certification Course by
              <span className="block text-purple-300 text-3xl md:text-4xl mt-2">
                Zodiac Premium
              </span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Exclusive for Zodiac HR's applicants and recruitment beneficiaries. 
              Master 32 cutting-edge AI tools and become an AI-certified professional in just 4 months.
            </p>
            
            {/* Special Pricing */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-8 max-w-2xl mx-auto">
              <h3 className="text-xl font-bold text-white mb-4 text-center">💰 Zodiac Premium Pricing</h3>
              <div className="text-center">
                <div className="mb-4">
                  <div className="text-lg text-gray-300 line-through mb-2">₹34,999/-</div>
                  <div className="text-3xl font-bold text-yellow-400 mb-2">₹3,999/month for 4 months</div>
                  <div className="text-xl text-green-300">or ₹15,996/- for full course</div>
                </div>
                <p className="text-blue-200 text-sm">Exclusive pricing for Zodiac HR applicants and beneficiaries</p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Arijit Chowdhury brings over 18 years of experience in AI, banking, and digital transformation. 
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">18+ years in AI & Banking</span>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="text-center">
              <div className="w-64 h-64 mx-auto mb-6">
                <img 
                  ...
                  alt="Arijit Chowdhury - AI Expert and Banking Professional"
              ...
              <p className="text-lg text-gray-600">AI Expert & Banking Professional</p>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Join thousands of banking and finance professionals who have transformed their careers 
      ...
      <PaymentModal 
        ...
        defaultCourse="Zodiac Premium AI Course"
        restrictToZodiacCourse={true}
      />
    </div>
  )
}

export default ZodiacPremiumAI