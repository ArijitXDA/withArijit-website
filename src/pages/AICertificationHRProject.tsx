...
const AICertificationHRProject: React.FC = () => {
  const { user } = useAuth()
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Arijit Chowdhury brings over 18 years of experience in AI, marketing, and digital transformation. 
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">18+ years in AI & Marketing</span>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="text-center">
              <div className="w-64 h-64 mx-auto mb-6">
                <img 
                  ...
                  alt="Arijit Chowdhury - AI Expert and Marketing Professional"
              ...
              <p className="text-lg text-gray-600">AI Expert & Marketing Professional</p>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Join thousands of HR, project, and product management professionals who have transformed their careers 
...
export default AICertificationHRProject