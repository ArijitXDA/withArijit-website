...
const AICertificationStartups: React.FC = () => {
  const { user } = useAuth()
  ...
  const perfectForRoles = [
    'Startup Founders', 'Entrepreneurs', 'Business Owners', 'Tech Leaders', 
    'Innovation Managers', 'Product Managers', 'Growth Hackers', 
    'Business Strategists', 'Venture Capitalists', 'Angel Investors', 
    'Startup Advisors', 'Business Consultants'
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Transform your startup with AI skills that matter. Master 32 cutting-edge AI tools 
              and become an AI-certified entrepreneur in just 4 months.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The AI revolution is here. Don't get left behind - join the entrepreneurs who are future-proofing their startups.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">🎯 Exclusive Startup Opportunities</h3>
              <p className="text-lg text-gray-700">
                Certified entrepreneurs get access to AI opportunities from <span className="font-bold text-blue-600">8000+ companies</span> across 
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-sm text-center">
                ...
                <p className="text-gray-600 text-sm">Access to top Indian startups and unicorns</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm text-center">
                <div className="text-3xl mb-3">🇺🇸</div>
                <h4 className="font-bold text-gray-900 mb-2">USA</h4>
                <p className="text-gray-600 text-sm">Silicon Valley and venture capital opportunities</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm text-center">
                <div className="text-3xl mb-3">🇨🇦</div>
                <h4 className="font-bold text-gray-900 mb-2">Canada</h4>
                <p className="text-gray-600 text-sm">Tech hubs and innovation centers</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              20 comprehensive sessions designed for entrepreneurs and startup founders
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Comprehensive benefits that transform your startup prospects
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Arijit Chowdhury brings over 18 years of experience in AI, entrepreneurship, and digital transformation. 
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">18+ years in AI & Entrepreneurship</span>
                </div>
                <div className="flex items-center space-x-3">
            ...
            <div className="text-center">
              <div className="w-64 h-64 mx-auto mb-6">
                <img 
                  ...
                  alt="Arijit Chowdhury - AI Expert and Entrepreneur"
              ...
              <p className="text-lg text-gray-600">AI Expert & Entrepreneur</p>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Join thousands of entrepreneurs and startup founders who have transformed their businesses 
...
export default AICertificationStartups